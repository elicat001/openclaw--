...
export const CHANNEL_IDS: readonly string[] = [...CHAT_CHANNEL_ORDER];

export type ChatChannelMeta = ChannelMeta;

const CHAT_CHANNEL_META: Record<ChatChannelId, ChannelMeta> = {} as Record<
  ChatChannelId,
  ChannelMeta
>;

export const CHAT_CHANNEL_ALIASES: Record<string, ChatChannelId> = {} as Record<
  string,
  ChatChannelId
>;
